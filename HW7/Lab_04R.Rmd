...
The dendogram obtained from the complete method looks better than the average method. But I do not think that either of them are useful. There are so many data points at the bottom and all are clustered so close together, I do not see any useful information in heirarchy.
```
...
ggpairs plot gave me much more useful information than the dendogram. Here, I can see variables that are highly correlated and also the clusters between them.
```
